...
public class GenerateConstructorUsingFieldsRefactoringRunner extends RefactoringRunner {
	...
	public GenerateConstructorUsingFieldsRefactoringRunner(IFile file, ISelection selection, ICElement element,
	...
	@Override
	public void run() {
		GenerateConstructorUsingFieldsRefactoring refactoring = new GenerateConstructorUsingFieldsRefactoring(element,
				selection, project);
