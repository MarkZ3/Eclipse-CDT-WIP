...
public class GenerateConstructorInsertEditProvider implements Comparable<GenerateConstructorInsertEditProvider> {
	...
	public GenerateConstructorInsertEditProvider(IASTDeclSpecifier declSpecifier, IASTDeclarator declarator,
			int visibility) {
		super();
	...
	public String toString() {
		...
		return fieldDeclarator.getName().toString() + " : " + fieldDeclSpecifier.toString() + operatorsStr; //$NON-NLS-1$
	}
